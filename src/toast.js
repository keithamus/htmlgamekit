...
export default class GameToast extends GameComponent {
  static attrs = {
    ...
    position: {
      type: "enum",
      values: ["center", "bottom", "top", "inline"],
      default: "center",
    },
  };
  ...
  static template =
    '<div class="persist" part="persist"></div><div class="sr-only" role="status" aria-live="polite"></div>';
  ...
  show(text, opts = {}) {
    ...
    if (opts.duration)
      el.style.setProperty("--game-toast-duration", `${opts.duration}ms`);
