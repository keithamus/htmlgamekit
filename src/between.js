...
export default class GameBetween extends GameComponent {
  ...
  #populate(s) {
    ...
    for (const el of this.querySelectorAll("[data-between=round-score]")) {
      el.textContent = lastScore != null ? (fmt ? fmt(lastScore) : String(lastScore)) : "";
    }
    ...
    if (lastScore != null) {
      ...
      if (good != null && bad != null) {
        // For asc (lower-is-better): score < good → "good", score >= bad → "bad".
        // For desc (higher-is-better): comparisons flip.
