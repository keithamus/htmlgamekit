...
export { default as GamePreferences, GamePreference, GamePreferenceChangeEvent } from "./preferences.js";
...
// Re-imported for use in defineAll(). ES modules require a local binding
// to call .define() — the re-export above is consumer-facing only.
