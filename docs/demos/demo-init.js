import { defineAll, GameComponent, css, GameRoundPassEvent, GameRoundFailEvent, GameStatUpdateEvent } from "../../src/index.js";
...
class DemoTarget extends GameComponent {
  static styles = css`
    ...
    .target {
      ...
      background: var(--game-accent, #fff); cursor: pointer;
...
export { GameComponent, css, GameRoundPassEvent, GameRoundFailEvent, GameStatUpdateEvent };
