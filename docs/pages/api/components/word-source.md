...
{% include "demo-embed.html", demo: "word-source", title: "Word source demo", height: "480px" %}
...
<game-word-source words-url="https://words.htmlgamekit.dev"
                  theme="animal+food" length="5" mode="daily">
</game-word-source>
```
...
This means game logic — including `<word-game>` and any other listener — only sees submit events for real dictionary words.
...
```html
<game-shell game-id="my-wordle" rounds="5" score-order="desc" between-delay="1200">
  <game-word-source words-url="https://words.htmlgamekit.dev"
...
```html
<game-word-source words-url="https://words.htmlgamekit.dev"
                  length="5" theme="animal" mode="per-round">
</game-word-source>
```
