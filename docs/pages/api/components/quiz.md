...
{% include "demo-embed.html", demo: "quiz", title: "Quiz demo", height: "450px" %}
...
<div when-some-scene="playing between paused">
  <game-quiz>
    ...
    <fieldset data-tier="0">
      ...
      <label>
        <input type="radio" name="q" value="Lyon"> Lyon
      </label>
      <label>
        <input type="radio" name="q" value="Marseille"> Marseille
      </label>
      <label>
        <input type="radio" name="q" value="Nice"> Nice
      </label>
    </fieldset>
    ...
    <fieldset data-tier="1">
      ...
      <label>
        <input type="radio" name="q" value="Izmir"> Izmir
      </label>
      <label>
