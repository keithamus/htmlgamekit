...
describe("game-challenge", () => {
  ...
  it("creates from document.createElement", () => {
    const el = document.createElement("game-challenge");
    assert.instanceOf(el, HTMLElement);
    assert.equal(el.localName, "game-challenge");
  });

  it("has shadow DOM with .label, .score, .taunt", () => {
    const el = document.createElement("game-challenge");
    assert.isNotNull(el.shadowRoot);
    assert.isNotNull(el.shadowRoot.querySelector(".label"));
    assert.isNotNull(el.shadowRoot.querySelector(".score"));
    assert.isNotNull(el.shadowRoot.querySelector(".taunt"));
  });
